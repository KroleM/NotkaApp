...
namespace NotkaAPI.Migrations
{
    ...
    [Migration("20240707140535_passwordSalt")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotkaAPI.Models.CMS.Feed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotkaAPI.Models.Investments.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotkaAPI.Models.Notes.TaskClass", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotkaAPI.Models.CMS.Feed", b =>
                {
                    b.HasOne("NotkaAPI.Models.General.Picture", "Picture")
                        .WithMany()
            ...
            modelBuilder.Entity("NotkaAPI.Models.General.Picture", b =>
                {
                    b.HasOne("NotkaAPI.Models.Notes.Note", null)
                        .WithOne("Picture")
            ...
            modelBuilder.Entity("NotkaAPI.Models.General.Request", b =>
                {
                    ...
                    b.HasOne("NotkaAPI.Models.Notes.TaskClass", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("NotkaAPI.Models.Investments.StockExchange", b =>
                {
                    b.HasOne("NotkaAPI.Models.Investments.Country", "Country")
