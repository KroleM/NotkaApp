...
namespace NotkaDesktop.Services.Abstract
{
	...
	{
		protected readonly NotkaDesktopService _service;
		protected ADataStore()
		{
			...
			_service = new NotkaDesktopService("https://localhost:7089/", client);

			//Swagger RestAPI address for Android (use only one!)
			//_service = new NotkaDesktopService("https://10.0.2.2:7089/", client);
		}
	}
}
