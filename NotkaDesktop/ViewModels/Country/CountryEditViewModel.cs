...
{
	public partial class CountryEditViewModel : AEditViewModel<CountryForView, CountryParameters>
	{
		public CountryEditViewModel(CountryDataStore dataStore, int itemId) 
			: base("Edycja kraju", dataStore, itemId)
		{
		}
